...
class QnasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qna" do
    assert_difference('Qna.count') do
      post qnas_url, params: { qna: { answer_email: @qna.answer_email, content: @qna.content, title: @qna.title, user_name: @qna.user_name } }
    end
  ...
  test "should update qna" do
    patch qna_url(@qna), params: { qna: { answer_email: @qna.answer_email, content: @qna.content, title: @qna.title, user_name: @qna.user_name } }
